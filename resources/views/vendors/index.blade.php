                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($vendor->role === 'admin')
                                                <span class="badge bg-success">{{ ucfirst($vendor->role) }}</span>
                                            @elseif ($vendor->role === 'user')
                                                <span class="badge bg-primary">{{ ucfirst($vendor->role) }}</span>
                                            @else
                                                <span class="badge bg-secondary">{{ ucfirst($vendor->role) }}</span>
                                            @endif
                                        </td>
